...
const TaskInfoBox = () => {
  ...
  return (
    <div className=" w-[95%] md:w-[60%] lg:w-[50%] 2xl:w-[30%] m-auto flex flex-row-reverse justify-between border rounded sm:p-5 sm:py-8 p-3 items-center">
      {getTargetInfoIsPending ? (
        <div className="w-full justify-between items-center flex p-16">
