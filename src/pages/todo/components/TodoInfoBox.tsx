const TodoInfoBox = () => {
  return (
    <div className=" w-[95%] md:w-[60%] lg:w-[50%] 2xl:w-[30%] m-auto flex flex-row-reverse border rounded sm:p-8 p-5 py-8 justify-between items-center">
      ...
      {/* data circle */}
      <div className=" bg-secondary flex justify-center self-center items-center text-center sm:w-47 sm:h-47 w-40 h-40 text-white relative rounded-full drop-shadow-2xl shadow-2xl shadow-black">
